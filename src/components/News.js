...
const News=(props)=> {
  ...
  useEffect(() => {
    document.title=`${capFirst(props.category)}-Daily News`;
    updateNews();
  ...
  const fetchMoreData=async ()=>{
    ...
    return (
      <>
      <h1 className="text-center" style={{margin:"35px 0",marginTop:'90px'}}>Daily News-Top {capFirst(props.category)} Headlines</h1>
      {loading && <Spinner/>}
